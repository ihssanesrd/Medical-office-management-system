...
namespace WindowsFormsApp3 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class MedecinDataTable : global::System.Data.TypedTableBase<MedecinRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public MedecinRow AddMedecinRow(string nom, string prenom, string specialite, string adresse, string ville, string tel, string login, string mdp) {
            ...
            private void InitClass() {
                ...
                this.columnspecialite.AllowDBNull = false;
                this.columnspecialite.MaxLength = 70;
...
namespace WindowsFormsApp3.Database1DataSetTableAdapters {
    ...
    public partial class MedecinTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Medecin] WHERE (([medecin_id] = @Original_medecin_id) AND ([nom] = @Original_nom) AND ([prenom] = @Original_prenom) AND ([specialite] = @Original_specialite) AND ([adresse] = @Original_adresse) AND ([ville] = @Original_ville) AND ([tel] = @Original_tel) AND ([login] = @Original_login) AND ([mdp] = @Original_mdp))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Medecin] ([nom], [prenom], [specialite], [adresse], [ville], [tel], [login], [mdp]) VALUES (@nom, @prenom, @specialite, @adresse, @ville, @tel, @login, @mdp);
SELECT medecin_id, nom, prenom, specialite, adresse, ville, tel, login, mdp FROM Medecin WHERE (medecin_id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Medecin] SET [nom] = @nom, [prenom] = @prenom, [specialite] = @specialite, [adresse] = @adresse, [ville] = @ville, [tel] = @tel, [login] = @login, [mdp] = @mdp WHERE (([medecin_id] = @Original_medecin_id) AND ([nom] = @Original_nom) AND ([prenom] = @Original_prenom) AND ([specialite] = @Original_specialite) AND ([adresse] = @Original_adresse) AND ([ville] = @Original_ville) AND ([tel] = @Original_tel) AND ([login] = @Original_login) AND ([mdp] = @Original_mdp));
SELECT medecin_id, nom, prenom, specialite, adresse, ville, tel, login, mdp FROM Medecin WHERE (medecin_id = @medecin_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT medecin_id, nom, prenom, specialite, adresse, ville, tel, login, mdp FROM " +
                "dbo.Medecin";
        ...
        public virtual int Fill(Database1DataSet.MedecinDataTable dataTable) {
        ...
        public virtual Database1DataSet.MedecinDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.MedecinDataTable dataTable = new Database1DataSet.MedecinDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.MedecinDataTable dataTable) {
        ...
        public virtual int Delete(int Original_medecin_id, string Original_nom, string Original_prenom, string Original_specialite, string Original_adresse, string Original_ville, string Original_tel, string Original_login, string Original_mdp) {
            ...
            if ((Original_specialite == null)) {
                throw new global::System.ArgumentNullException("Original_specialite");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_specialite));
            }
        ...
        public virtual int Insert(string nom, string prenom, string specialite, string adresse, string ville, string tel, string login, string mdp) {
            if ((nom == null)) {
            ...
            if ((specialite == null)) {
                throw new global::System.ArgumentNullException("specialite");
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((Original_specialite == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_specialite));
            }
            if ((Original_adresse == null)) {
                throw new global::System.ArgumentNullException("Original_adresse");
            }
            ...
            if ((Original_mdp == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((string)(Original_mdp));
            }
            this.Adapter.UpdateCommand.Parameters[17].Value = ((int)(medecin_id));
        ...
        public virtual int Update(
                    ...
                    string Original_login, 
                    string Original_mdp) {
            return this.Update(nom, prenom, specialite, adresse, ville, tel, login, mdp, Original_medecin_id, Original_nom, Original_prenom, Original_specialite, Original_adresse, Original_ville, Original_tel, Original_login, Original_mdp, Original_medecin_id);
        }
    }
